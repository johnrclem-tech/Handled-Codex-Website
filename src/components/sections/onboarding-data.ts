...
export const onboardingStepNames: OnboardingStepBase[] = [
  { title: "Integrate and automate", badge: "Week 1" },
  { title: "Make shipping part of the sale", badge: "Week 1–2" },
  { title: "Brand literally everything", badge: "Week 2" },
]

export const shopifyOnboardingData: OnboardingTimelineItem[] = [
  {
...
export const apparelOnboardingData: OnboardingTimelineItem[] = [
  {
    title: "Integrate and automate",
    date: "Week 1",
    stepLabel: "Step 1",
...
export const cosmeticsOnboardingData: OnboardingTimelineItem[] = [
  {
    title: "Integrate and automate",
    date: "Week 1",
    stepLabel: "Step 1",
...
export const ecommerceOnboardingData: OnboardingTimelineItem[] = [
  {
    title: "Integrate and automate",
    date: "Week 1",
    stepLabel: "Step 1",
