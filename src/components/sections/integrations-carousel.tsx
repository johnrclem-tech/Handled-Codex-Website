...
export const defaultCarouselIntegrations: IntegrationLogo[] = [
  ...
  { name: "eBay", icon: SiEbay, color: "text-[#E53238]", iconClassName: "h-14 w-auto" },
  { name: "Walmart", icon: SiWalmart, color: "text-[#0071DC]", iconClassName: "h-14 w-auto" },
  ...
  { name: "FedEx", icon: SiFedex, color: "text-[#4D148C]", iconClassName: "h-14 w-auto" },
  { name: "DHL", icon: SiDhl, color: "text-[#FFCC00]", iconClassName: "h-14 w-auto" },
