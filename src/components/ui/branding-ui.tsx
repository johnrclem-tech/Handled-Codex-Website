          ...
          <div className="rounded-lg border border-border bg-muted/30 p-4">
            <div className="flex gap-3">
              <div className="w-16 h-16 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0">
                <HiOutlineCube className="h-7 w-7 text-primary" />
              </div>
          ...
          <div className="rounded-lg border border-border bg-muted/50 p-4">
            <div className="flex items-center gap-2 mb-3">
              <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center">
                <HiOutlineEnvelope className="h-4 w-4 text-primary" />
              </div>
              <div>
            ...
            <div className="rounded-lg border border-border bg-background p-3 space-y-2">
              <div className="flex items-center gap-2">
                <div className="h-5 w-5 rounded bg-primary flex items-center justify-center">
                  <span className="text-primary-foreground text-[9px] font-bold">YB</span>
                </div>
              ...
              <div className="mt-2 h-7 w-24 rounded bg-primary flex items-center justify-center">
                <span className="text-primary-foreground text-[10px] font-medium">Track Order</span>
              </div>
            </div>
          </div>
        </div>
...
function BrandItem({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-1.5">
      <HiOutlineCheckCircle className="h-3 w-3 text-primary shrink-0" />
