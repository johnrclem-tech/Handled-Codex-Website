...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: canonicalForPath("/industries/cosmetics-fulfillment"),
  },
}
  ...
  return (
    <>
      ...
      <main>
        ...
        <FAQCardGrid
          label="FAQ"
          heading="Cosmetics fulfillment questions, answered"
          description="Everything you need to know about outsourcing fulfillment for your beauty brand."
          bgColor="bg-muted/30"
          faqItems={faqs}
        />
