...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: canonicalForPath("/industries/apparel-fulfillment"),
  },
}
  ...
  return (
    <>
      ...
      <main>
        ...
        <FAQCardGrid
          label="FAQ"
          heading="Apparel fulfillment questions, answered"
          description="Everything you need to know about outsourcing fulfillment for your clothing brand."
          bgColor="bg-muted/30"
          faqItems={faqs}
        />
